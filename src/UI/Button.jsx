      ...
      <div className="main">
        <div className="up">
          ...
          <button className="card2">
            {/* LinkedIn SVG */}
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 34" width="30px" height="30px" className="linkedin">
              <path d="M34,20.3v10.4h-6.9v-9.8c0-2.3-0.8-3.9-2.7-3.9c-1.5,0-2.4,1-2.8,2v11.6h-6.9c0,0,0.1-18.8,0-20.7h6.9v2.9 c0.9-1.4,2.4-3.4,5.8-3.4C31.3,17.4,34,18.9,34,20.3zM4.5,7.4c-2.3,0-3.8,1.5-3.8,3.5c0,2,1.4,3.5,3.6,3.5h0c2.3,0,3.8-1.5,3.8-3.5 C8.1,8.9,6.9,7.4,4.5,7.4zM7,30.7H2v-20.7h5V30.7z" />
            </svg>
          </button>
        </div>
        <div className="down">
