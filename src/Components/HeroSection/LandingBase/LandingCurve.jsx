...
const LandingCurve = () => {
  return (
    <div
      ...
      >
        <div
          className="absolute bottom-[167px] left-1/2 h-[111px] w-[787px] -translate-x-1/2 transform overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,#432dd7_0%,rgba(10,10,10,0)_100%)] blur-[57px] dark:bg-[radial-gradient(50%_50%_at_50%_50%,#5506ba_0%,rgba(10,10,10,0)_100%)]"
          style={{ transform: 'translateX(-94.4158px)' }}
        />

        <div
          className="absolute right-[-432px] bottom-[-753px] left-[-454px] h-[955px] rounded-[100%] bg-gradient-to-b from-black to-transparent dark:from-white"
        />
