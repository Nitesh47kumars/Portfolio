...
const HeroContent = () => {
  return (
    <div className="w-full flex flex-col max-md:items-center md:items-start gap-4 max-md:gap-3">
      ...
      <h1 className="uppercase font-bold text-[#E8AA14] leading-none md:text-[clamp(2rem,5vw,3.7rem)] max-md:text-[clamp(1.8rem,6vw,2rem)]">
        Nitesh Kumar
      </h1>
      ...
      <div className="flex flex-col md:flex-row items-center w-full gap-2 max-md:gap-3">
