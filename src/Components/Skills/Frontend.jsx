...
const Frontend = () => {
  return (
    <div
      ...
      className="relative md:col-span-3 lg:col-span-4 p-5 lg:h-50 max-sm:h-65 max-lg:h-80 rounded bg-black group transition-shadow duration-500 shadow-[inset_0_0_40px_rgba(180,180,180,0.1)]"
    >
        ...
        {lang.map((curr, idx) => {
          ...
          return (
            <li key={idx} className="flex flex-col items-center">
              ...
              >
                <div
                  className="grid h-full place-items-center rounded-[10px] max-md:rounded-8 border-2 border-[#A5AEB81F]/10 bg-[#1A1B1E]"
                  style={{
