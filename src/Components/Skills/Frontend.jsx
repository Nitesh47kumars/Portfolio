...
const Frontend = () => {
  ...
  return (
    <div className='col-span-2 h-[300px] rounded-xl bg-black transition-all duration-500 group
    shadow-[inset_6px_6px_60px_rgba(225,225,225,0.2)] hover:shadow-[inset_0_0px_80px_rgba(255,255,255,0.2)]'>
      ...
      <ul className='flex justify-between p-5'>
        {images.map((curr,idx)=>{
          return <li
          key={idx}
          className="h-28 w-28 rounded-[20px] border-2 p-2 transition-all duration-500 md:group-hover:-translate-y-2 md:group-hover:border-indigo-400
            hover:border-blue-600">
              <div className="grid h-full place-items-center rounded-xl border-2 border-[#A5AEB81F]/10 bg-[#EDEEF0] dark:border-[#5A5F661F]/10 dark:bg-[#1A1B1E]"
                ...
                <img className="h-10 w-10 object-cover" src={curr} alt="img"/>
              </div>
          </li>
        })}
      </ul>
