...
const NavbarList = () => {
  ...
  return (
    <div>
        <ul className='flex gap-10 font-semibold md:flex-row max-md:flex-col max-md:absolute  max-md:top-[100px] max-md:left-0 max-md:w-full max-md:text-center max-md:backdrop-blur-lg md:bg-black'>
            {links.map((curr,idx)=>{
